...
from gimmie.main import download_file, read_urls_from_file, download_files_from_list
...
def url_file():
    ...
    with tempfile.NamedTemporaryFile(mode='w', delete=False) as f:
        f.write("https://raw.githubusercontent.com/laywill/gimmie/refs/heads/main/README.md\n")
...
def test_read_urls_from_file(url_file):
    ...
    assert len(urls) == 3
    assert urls[0] == "https://raw.githubusercontent.com/laywill/gimmie/refs/heads/main/README.md"
...
def test_integration_with_real_file():
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        url = "https://raw.githubusercontent.com/laywill/gimmie/refs/heads/main/README.md"
